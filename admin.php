...
<body style="background-image:url(m.jpg); background-size:cover;" align="center">
<br>
	<center><h2><p>Selamat Datang Di Halaman Event|SMK Luqman AL Hakim</p></h2>
	<hr>
<center><h1>Data event</h1>
<br>
...
<table border="1" align="center">
	...
	while ($hasil=mysqli_fetch_array($tampil)){
		...
		<tr bgcolor="gray" style="color: white">
			...
			<td>
				<a href="edit_admin.php?id=<?php echo $hasil['id'];?>" class="btn btn-primary btn block">edit</a>|
				<a href="hapus_admin.php?hapus&id=<?=$hasil['id'];?>" class="btn btn-danger btn block">hapus</a>
			</td>
		</tr>
		<?php
	}
